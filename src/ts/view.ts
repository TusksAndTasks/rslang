import { model } from ".";
import { EPage, IAuth, IElectronBook, IHeader, ISprint, ISprintDifficulty, ISprintStat, ITemplate } from "../types/types";
...
export class View {
  ...
  constructor(header: IHeader, footer: ITemplate, auth: IAuth, main: ITemplate, electronBook: IElectronBook, audiocall: ITemplate, sprint: ISprint, sprintStat: ISprintStat, sprintDifficulty: ISprintDifficulty, statistics: ITemplate) {
    this.header = header;
    this.footer = footer;
    this.auth = auth;
    this.main = main;
